	...
	<div class="holder">	
		<div class="holder3">	
			...
			if($_GET['ida'])
			{
				   ...
				   echo '<h1 style="margin-left: 120px;">[nadpis]</h1>';  
		...
		<div class="main_pravy">
				<div class="aktuality_pravy_nadpis">NEJPRODÁVANĚJŠÍ ZBOŽÍ</div>
				<div class="clear" style="height: 30px;"></div>
				<?
				echo nejprodavanejsi_aktuality(3);
				?>
		</div>	
