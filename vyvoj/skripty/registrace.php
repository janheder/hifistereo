...
$registrace_t .= '<tr><td colspan="2" ><div class="checkbox-field"><input class="form-check__input" type="checkbox" name="souhlas_ou" value="1" required> <label>'.__REGISTRACE_SOUHLAS_SE_ZPRAC_OS_UD__.'</label></div></td></tr>';
